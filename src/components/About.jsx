...
const About = () => {
  return (
      <div className='bg-darkBlue w-full mt-20 my-20 relative bg-gpt3 p-8 lg:p-12'>
      ...
      <div className='flex flex-col sm:flex-row py-4'>
        ...
        <p className='font-Manrope text-[12px] sm:text-[14px] font-medium leading-[24px] sm:leading-[30px] text-secondary lg:px-20'>
      ...
      <div className='flex flex-col lg:flex-row py-4'>
        {improvements.map( improvement => (
            <div key={improvement.id} className='my-10'>
              ...
              <p className='font-Manrope text-[12px] sm:text-[14px] font-medium leading-[24px] sm:leading-[30px] text-secondary mr-8'>
                {improvement.content}
              </p>
            </div>
        ))}
